...
public class InputKeyboardTalkback extends AppCompatActivity {
    EditTextBackEvent textResult;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_input_keyboard_talkback);
    ...
    {
        super.onResume();
        try{GlobalVars.alarmVibrator.cancel();
        }

        catch(NullPointerException e){}catch(Exception e){}
        GlobalVars.lastActivity = InputKeyboardTalkback.class;
        GlobalVars.talk(getResources().getString(R.string.app_name));
    }
